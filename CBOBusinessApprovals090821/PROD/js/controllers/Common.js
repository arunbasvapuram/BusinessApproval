                        ...
                        || val.ImmigrationRoles == "OPL" || val.ImmigrationRoles == "OBUSER"){
                            $(val.Approvers.results).each(function (di, va) {
                                if (va.EMail == loginEmail && !orderBoardLinkAdded) {
                                   // $('.nav.navbar-nav').append('<li><a href="#" class="dropdown-toggle" data-toggle="dropdown">Order Board<b class="caret"></b></a><ul class="dropdown-menu" style="font-size: 11px;"><li class="dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Reporting<ul class="dropdown-menu" style="font-size: 11px;"><li><a href="OrderBoardReport.aspx">Demand Supply Analysis</a></li><li><a href="OrderBoardDemandReport.aspx">OB Demand Report</a></li></ul></li><li class="dropdown-submenu"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Update Data<ul class="dropdown-menu" style="font-size: 11px;"><li><a href="OrderBoardData.aspx">Order Board Upload</a></li><li><a href="OrderBoardDemandUpdate.aspx">OB Demand Update</a></li></ul></li></ul></li>');
