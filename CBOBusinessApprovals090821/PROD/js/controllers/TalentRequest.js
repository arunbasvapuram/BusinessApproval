...
function loadJSSet() {
    if (jsFilePaths.length > 0) {
        ...
        $('#requestTypeidentifier').text("New Leaves Request");
        ...
        LoadOfferingApproversData().done(function (data, textStatus, jqXHR) {
            ...
            $(allData).each(function (index, item) {
                if (code == "RM") {
                    ...
                    if (item.Title == "SYSENG ES" && currentOffering == metadata.offerings.systemsEngineering) {
                    ...
                    else if (item.Title == "OPSTRANS ES" && currentOffering == metadata.offerings.operationsTransformation) {
                        messages.push("Talent Engagement Specialist(ES) for your respective Offering");
                        var itm = $(item.MarketOfferingApprover).text();
                        $(itm.split(";")).each(function (index, item) {
                            messages.push(item);
                    ...
                    else if (item.Title == "CLOUDENG ES" && currentOffering == metadata.offerings.cloudEngineering) {
                        messages.push("Talent Engagement Specialist(ES) for your respective Offering");
                        var itm = $(item.MarketOfferingApprover).text();
                        $(itm.split(";")).each(function (index, item) {
                            messages.push(item);
                    ...
                    else if (item.Title == "CIS ES" && currentOffering == metadata.offerings.coreIndustrySolutions) {
