...
function loadJSSet() {
    if (jsFilePaths.length > 0) {
        ...
        if(isFreezePeriod){
            header = "Please Note";
            message = "<p style='line-height:2em'>We are not taking in any Transfer Requests which includes Inter Portfolio, Inter Offering, Across Locations owing to a firm wide freeze till the 10th of July. </br> Guidelines for transfers for FY 22 are expected to be rolled out soon on the CBO Portal. </br> If you have a request that is urgent then you are advised to check with your TBA and take it ahead.</p>";
        }
        else if(isInterOffering){
...
if(currentDate <= new Date('2021-07-10')){
    isFreezePeriod = true;
}
if (urlParam("Type") == "L") {
    isInterOffice = true;
