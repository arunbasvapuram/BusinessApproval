    ...
    loadListItems({
        ...
        success: function (data) {
            if (data.length === 0) {
				...
				// $('.nav.navbar-nav').append('<li><a href="' + siteUrl + '/Pages/OrderBoardData.aspx">Order Board Tool</a></li>');
...
function checkPMToShowCeertApproval(){
    ...
    $.ajax({
        url: "https://americas.internal.deloitteonline.com/sites/USICBOPortal/UsiCboBusinessApprovals/_api/web/lists/getbytitle('Certification Requests')/items?$select=*,Project_x0020_Manager/EMail&$expand=Project_x0020_Manager&$filter=PM_x0020_Approval_x0020_Status eq 'Pending'",
